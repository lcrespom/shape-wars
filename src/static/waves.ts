...
/* ToDo:
	- Routes: N, inverted N, loop
	- Random entry point for routes (within a range)
	- Fully random routes (low priority)
...
export default {
	squadrons: [
		...
		{ route: routeD, shape: enemyShape1, ships: 5, steps: 20, delay: 370 },
		{ route: routeC, shape: enemyShape2, ships: 5, steps: 20, delay: 470 }
	]
};
